...
<p>The Logs Analysis project is the 3rd project of the Full Stack Nanodegree program from Udacity. 
   ...
   <ol>
   <li>Download and install <a href='https://www.virtualbox.org/' target='_blank'>Virtual Box</a>
   <li>Downlaod and install <a href='https://www.vagrantup.com/downloads.html' target='_blank'>Vagrant</a>
